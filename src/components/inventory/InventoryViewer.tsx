...
export function InventoryViewer({ 
  ...
  const mediaUrl = currentItem.public_url || currentItem.default_public_url;
      ...
      >
        <DialogHeader className="w-full relative mb-2 flex-shrink-0">
          <DialogTitle className="pr-8 flex items-center gap-2">
            ...
            {currentItem.product_name || currentItem.caption || "Media Preview"}
            {allMedia.length > 1 && (
            ...
            <div className="space-y-4">
              {currentItem.product_name && (
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{currentItem.product_name}</p>
                </div>
              )}
              {currentItem.caption && (
                <div>
              ...
              {currentItem.product_code && (
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{currentItem.product_code}</p>
                </div>
              )}
              <div>
